...
hero:
  ...
  actions:
    - text: 가이드 보러가기
      link: /dsm-freshman-guide/start/00-start
      icon: right-arrow
      variant: secondary
    - text: Github 바로가기
...
<div class="text-lg max-w-[830px] text-justify">
  ...
  <div class="mb-2">
  <span class="font-semibold text-transparent text-sky-500 dark:text-sky-500">어떻게 배워야 하나요?</span>
  </div>
...
<div class="text-lg max-w-[830px] text-justify">
  ...
  <div class="mb-2">
  <span class="font-semibold text-transparent text-sky-500 dark:text-sky-500">어떻게 시작해야 하나요?</span>
  </div>
