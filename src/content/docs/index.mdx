...
<div class="text-lg max-w-[830px] text-justify">
  ...
  <div class="mb-2">
  <span class="font-semibold text-transparent text-sky-600 dark:text-sky-500">어떻게 배워야 하나요?</span>
  </div>
...
<div class="text-lg max-w-[830px] text-justify">
  ...
  <div class="mb-2">
  <span class="font-semibold text-transparent text-sky-600 dark:text-sky-500">어떻게 시작해야 하나요?</span>
  </div>
